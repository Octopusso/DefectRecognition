...
data_inc = readtable('Matlab_Import\Training\General_Inclination.csv');
...
data_freq = readtable('Matlab_Import\Training\General_Frequency.csv');
...
data_damp = readtable('Matlab_Import\Training\General_Damper.csv');
