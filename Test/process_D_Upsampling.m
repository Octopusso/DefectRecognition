function process_D_Upsampling(dataDir)
%PROCESS_D_UPSAMPLING Upsamples the signal to a target frequency.
%   Inputs:
...
fprintf('Step D (Upsampling) completed for directory: %s\n', dataDir);
