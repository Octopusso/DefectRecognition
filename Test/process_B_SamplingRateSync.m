function process_B_SamplingRateSync(dataDir)
%PROCESS_B_SAMPLINGRATESYNC Corrects timebase and normalizes sampling rate.
%   Inputs:
%       dataDir - Directory containing the .mat files to process (e.g., 'Matlab_Import').

folderPath = dataDir; % Folder with .mat files
...
fprintf('Step B (Sampling Rate Sync) completed for directory: %s\n', dataDir);
