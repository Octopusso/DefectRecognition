function process_E_DataCutting(dataDir)
%PROCESS_E_DATACUTTING Cuts the data based on P5 sensor events.
%   Inputs:
...
fprintf('Step E (Data Cutting) completed for directory: %s\n', dataDir);
