...
% Combine damp and damp_loc into one joint target label
...
features_selected = {'rms_vel', 'rms_acc', 'damping_ratio'};
X = normalize(data{:, features_selected}, 'range');

% Convert to table format for model training
...
confChart.Title = 'Confusion Matrix – Combined damp + damp\_loc';
confChart.FontName = 'Calibri';
confChart.FontSize = 14;

%% Save the cross-validated model
save('Combined_Damp_Model.mat', 'model');
